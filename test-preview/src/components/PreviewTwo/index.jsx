        ...
        <div className="col-md-12">
          <div className="row">
            <wjViewer.PdfViewer
              ...
              fullScreenChanged={this.fullScreenChanged.bind(this)}
              zoomFactorChanged={this.zoomFactorChanged.bind(this)}
          ...
          <div className="row">
            <div className="form-horizontal">
              <div className="form-group">
                  ...
                  <div className="checkbox">
                    <label>
                      <input
                        ...
                        onChange={this.viewModeCheckedChanged.bind(this)}
                      />
                ...
                <div className="col-md-3">
                  <wjInput.Menu
                    value={this.state.mouseMode}
                    header="Mouse mode"
                    itemClicked={this.mouseModeChanged.bind(this)}
                  >
                  ...
                  <div className="checkbox">
                    <label>
                      <input
                        ...
                        onChange={this.fullScreenCheckedChanged.bind(this)}
                      />{" "}
                      Full Screen
                    </label>
                  </div>
                ...
                <div className="col-mod-4">
                  ...
                  <div className="col-md-2">
                    <wjInput.InputNumber
                      ...
                      step={0.1}
                      format="n2"
                      valueChanged={this.zoomFactorValueChanged.bind(this)}
                    ></wjInput.InputNumber>
                  </div>
                </div>
              </div>
